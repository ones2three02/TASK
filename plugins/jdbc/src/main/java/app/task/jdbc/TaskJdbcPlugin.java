...
public final class TaskJdbcPlugin {
    ...
    public static void main(String[] args) throws Exception {
        try (
            ...
            while ((line = reader.readLine()) != null) {
                ...
                writer.newLine();
                writer.flush();
                if (response.path("_task_close").asBoolean(false)) {
                    break;
                }
            }
        } finally {
    ...
    private static void registerDrivers(JsonNode connection) throws Exception {
        ...
        ClassLoader loader = urls.isEmpty()
            ...
            : new URLClassLoader(urls.toArray(URL[]::new), TaskJdbcPlugin.class.getClassLoader());
