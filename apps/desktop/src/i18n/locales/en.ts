export default {
  ...
  updates: {
    ...
    portableManualUpdate: "Portable builds cannot use the in-app installer. Download the portable ZIP from the release page, then extract it over the current TASK folder to keep portable.dbx and data.",
