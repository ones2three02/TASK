export default {
  ...
  connection: {
    ...
    jdbcPluginHint: "Install the TASK JDBC plugin first, then import the database vendor's JDBC driver JAR.",
  ...
  grid: {
    ...
    queryEditUnsupported: {
      ...
      "metadata-unavailable": "TASK could not load table metadata, so result editing is disabled.",
    },
  ...
  configExport: {
    ...
    cryptoUnavailable: "Encrypted config import is unavailable in this browser context. Use HTTPS, localhost, or TASK Desktop.",
  ...
  ai: {
    ...
    clear: "Clear Chat",
    welcome: "I am your TASK project AI assistant. How can I help you?",
    newChat: "New Chat",
    thinking: "Thinking...",
    reasoningProcess: "Thinking process",
    stopGenerating: "Stop generating",
    tableMentionEmpty: "No matching items",
    tableMentionPlaceholderHint: "(AI will plan based on the active project context)",
    tableMentionTypes: {
      table: "Table",
      view: "View",
    ...
    actions: {
      generate: "Breakdown Task",
      explain: "Analyze Action",
      optimize: "Refine Plan",
      fix: "Create Acceptance",
      convert: "Draft Document",
      sampleData: "Brainstorming",
    },
    placeholders: {
      generate: "Describe the project target or task, e.g. Design specification for new features",
      explain: "Input specific action/task content, let AI evaluate the key path and blockers",
      optimize: "Input current action steps, let AI optimize and detail the execution path",
      fix: "Input target or task description, let AI generate acceptance criteria",
      convert: "Input drafts or notes to organize into a structured Keep knowledge document",
      sampleData: "Input any ideas, plans or challenges you want to brainstorm about",
    },
  },
  contextMenu: {
    ...
    parameterDefaultHint: "When DEFAULT is checked, TASK omits that argument so the database uses the procedure default.",
  ...
  settings: {
    ...
    iconThemeDefaultDescription: "Use the color TASK app icon.",
    iconThemeBlack: "Black",
    iconThemeBlackDescription: "Use the black TASK mark for the window, tray, and logo.",
    showTrayIcon: "Show tray/menu bar icon",
    showTrayIconDescription: "When disabled, no icon is shown, but closing the window still hides TASK in the background as before.",
    updateNotificationsEnabled: "Enable update reminders",
    updateNotificationsEnabledDescription: "When disabled, TASK will not automatically check app or driver updates or show update badges. Manual checks are still available.",
    ...
    syncWebDavDescription: "Upload or restore a TASK snapshot from a WebDAV-compatible storage service.",
    ...
    syncRemotePathDescription: "TASK will create missing parent folders when uploading.",
    syncSecretNotice: "By default, TASK syncs connection details and settings only. Database passwords, SSH passwords, proxy passwords, connection strings, and AI API keys stay local.",
    syncSecrets: "Sync encrypted secrets",
    syncSecretsDescription: "When enabled, TASK encrypts database passwords, SSH passwords, and AI API keys before uploading them to WebDAV.",
    syncSecretsPassphrase: "Sync password",
    syncSecretsPassphraseDescription: "This password is only used to encrypt and restore sensitive data. TASK does not save it; enter it again on each device.",
    syncTest: "Test",
    syncUpload: "Upload",
    ...
    syncDownloadConfirm: "Download and apply the remote TASK snapshot? Local metadata and saved SQL will be replaced.",
    apply: "Apply",
    ...
    mcpTitle: "MCP Server",
    mcpDescription: "Check the TASK MCP Server installation and version used by Claude Code, Cursor, and other agents.",
    ...
    mcpReadonlyModeDescription: "Adds TASK_MCP_ALLOW_WRITES=0 to the sample config so the MCP session stays query-only.",
    mcpAllowDangerous: "Allow dangerous SQL",
    mcpAllowDangerousDescription: "Adds TASK_MCP_ALLOW_DANGEROUS_SQL=1 to the sample config so DROP, TRUNCATE, ALTER, and similar statements are allowed.",
    mcpDetectionTiming: "TASK checks automatically when this page opens; use Check again to refresh.",
    mcpNpmBoundary: "TASK only checks and explains MCP status; installation and upgrades still run through npm.",
  ...
  driverStore: {
    ...
    javaRuntimeManaged: "TASK managed JRE",
