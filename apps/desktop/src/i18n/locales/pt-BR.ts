export default {
  ...
  updates: {
    ...
    availableMessage: "TASK {latest} está disponível. Você está usando {current}.",
    upToDate: "O TASK está atualizado ({version}).",
    ...
    portableManualUpdate: "Versões portáteis não podem usar o instalador interno. Baixe o ZIP portátil da página de lançamento e extraia-o sobre a pasta atual do TASK para manter o portable.task e os dados.",
  ...
  sidebar: {
    ...
    importTask: "Importar Configuração TASK",
  ...
  connection: {
    ...
    jdbcPluginHint: "Instale primeiro o plugin JDBC do TASK e depois importe o JAR do driver JDBC do fornecedor do banco de dados.",
  ...
  grid: {
    ...
    queryEditUnsupported: {
      ...
      "metadata-unavailable": "O TASK não conseguiu carregar os metadados da tabela, portanto a edição do resultado está desabilitada.",
    },
  ...
  configExport: {
    ...
    cryptoUnavailable: "A importação criptografada não está disponível neste contexto do navegador. Use HTTPS, localhost ou TASK Desktop.",
  ...
  contextMenu: {
    ...
    parameterDefaultHint: "Quando DEFAULT está marcado, o TASK omite esse argumento para que o banco de dados use o padrão do procedimento.",
  ...
  settings: {
    ...
    iconThemeDefaultDescription: "Usar o ícone colorido do app TASK.",
    iconThemeBlack: "Preto",
    iconThemeBlackDescription: "Usar a marca TASK em preto na janela, na bandeja e no logo.",
    showTrayIcon: "Mostrar ícone na bandeja/barra de menus",
    showTrayIconDescription: "Quando desativado, nenhum ícone é exibido, mas fechar a janela ainda oculta o TASK em segundo plano como antes.",
    updateNotificationsEnabled: "Ativar lembretes de atualização",
    updateNotificationsEnabledDescription: "Quando desativado, o TASK não verificará automaticamente atualizações do app ou dos drivers nem mostrará indicadores. Verificações manuais continuam disponíveis.",
    ...
    syncWebDavDescription: "Envie ou restaure um snapshot do TASK a partir de um serviço de armazenamento compatível com WebDAV.",
    ...
    syncRemotePathDescription: "O TASK criará as pastas pai ausentes ao enviar.",
    syncSecretNotice: "Por padrão, o TASK sincroniza apenas detalhes de conexão e configurações. Senhas de banco de dados, senhas SSH, senhas de proxy, strings de conexão e chaves de API de IA permanecem locais.",
    syncSecrets: "Sincronizar segredos criptografados",
    syncSecretsDescription: "Quando ativado, o TASK criptografa senhas de banco de dados, senhas SSH e chaves de API de IA antes de enviá-las para o WebDAV.",
    syncSecretsPassphrase: "Senha de sincronização",
    syncSecretsPassphraseDescription: "Esta senha é usada apenas para criptografar e restaurar dados sensíveis. O TASK não a salva; digite-a novamente em cada dispositivo.",
    syncTest: "Testar",
    syncUpload: "Enviar",
    syncDownload: "Baixar",
    ...
    syncDownloadConfirm: "Baixar e aplicar o snapshot remoto do TASK? Os metadados locais e os SQL salvos serão substituídos.",
    apply: "Aplicar",
    ...
    jdbcPlugin: "Plugin JDBC do TASK",
    ...
    mcpDescription: "Verifique a instalação e a versão do Servidor MCP do TASK usado pelo Claude Code, Cursor e outros agentes.",
    ...
    mcpReadonlyModeDescription: "Adiciona TASK_MCP_ALLOW_WRITES=0 à configuração de exemplo para que a sessão MCP permaneça apenas para consultas.",
    mcpAllowDangerous: "Permitir SQL perigoso",
    mcpAllowDangerousDescription: "Adiciona TASK_MCP_ALLOW_DANGEROUS_SQL=1 à configuração de exemplo para que instruções como DROP, TRUNCATE, ALTER e similares sejam permitidas.",
    mcpDetectionTiming: "O TASK verifica automaticamente quando esta página é aberta; use Verificar novamente para atualizar.",
    mcpNpmBoundary: "O TASK apenas verifica e explica o status do MCP; a instalação e as atualizações ainda são feitas pelo npm.",
  ...
  driverStore: {
    ...
    javaRuntimeManaged: "JRE gerenciada pelo TASK",
