export default {
  ...
  updates: {
    ...
    availableMessage: "TASK {latest} está disponible. Estás usando la versión {current}.",
    upToDate: "TASK está actualizado ({version}).",
    ...
    portableManualUpdate: "Las versiones portables no pueden usar el instalador integrado. Descarga el ZIP portable desde la página de lanzamiento y extráelo sobre la carpeta actual de TASK para conservar portable.task y data.",
  ...
  sidebar: {
    ...
    importTask: "Importar configuración TASK",
  ...
  connection: {
    ...
    jdbcPluginHint: "Instala primero el plugin JDBC de TASK y luego importa el JAR del driver JDBC del proveedor.",
  ...
  configExport: {
    ...
    cryptoUnavailable: "La importación cifrada no está disponible en este navegador. Usa HTTPS, localhost o TASK Desktop.",
  ...
  contextMenu: {
    ...
    parameterDefaultHint: "Cuando DEFAULT está marcado, TASK omite ese argumento para que la base de datos use el valor predeterminado.",
  ...
  settings: {
    ...
    iconThemeDefaultDescription: "Usar el icono de color de TASK.",
    iconThemeBlack: "Negro",
    iconThemeBlackDescription: "Usar la marca negra de TASK en ventana, bandeja y logo.",
    showTrayIcon: "Mostrar icono en bandeja/barra de menú",
    showTrayIconDescription: "Si está desactivado, no se muestra el icono, pero cerrar la ventana sigue ocultando TASK en segundo plano como antes.",
    updateNotificationsEnabled: "Activar recordatorios de actualización",
    updateNotificationsEnabledDescription: "Al desactivarlo, TASK no comprobará automáticamente actualizaciones de la app ni de los controladores, ni mostrará indicadores. Las comprobaciones manuales siguen disponibles.",
    ...
    syncWebDavDescription: "Sube o restaura una instantánea de TASK desde almacenamiento compatible con WebDAV.",
    ...
    syncRemotePathDescription: "TASK creará las carpetas padre faltantes al subir.",
    syncSecretNotice: "De forma predeterminada, TASK solo sincroniza detalles de conexión y ajustes. Las contraseñas de base de datos, SSH, proxy, cadenas de conexión y API keys de IA quedan locales.",
    syncSecrets: "Sincronizar secretos cifrados",
    syncSecretsDescription: "Al activarlo, TASK cifra contraseñas de base de datos, contraseñas SSH y API keys de IA antes de subirlas a WebDAV.",
    syncSecretsPassphrase: "Contraseña de sync",
    syncSecretsPassphraseDescription: "Esta contraseña solo se usa para cifrar y restaurar datos sensibles. TASK no la guarda; tendrás que ingresarla en cada dispositivo.",
    syncTest: "Probar",
    syncUpload: "Subir",
    ...
    syncDownloadConfirm: "¿Descargar y aplicar la instantánea remota de TASK? Se reemplazarán metadatos locales y SQL guardado.",
    apply: "Aplicar",
    ...
    jdbcPlugin: "Plugin JDBC de TASK",
    ...
    mcpTitle: "MCP Server",
    mcpDescription: "Comprueba la instalación y versión de TASK MCP Server para Claude Code, Cursor y otros agentes.",
    ...
    mcpReadonlyModeDescription: "Añade TASK_MCP_ALLOW_WRITES=0 al ejemplo de configuración para que la sesión MCP solo permita consultas.",
    mcpAllowDangerous: "Permitir SQL peligroso",
    mcpAllowDangerousDescription: "Añade TASK_MCP_ALLOW_DANGEROUS_SQL=1 al ejemplo de configuración para permitir DROP, TRUNCATE, ALTER y sentencias similares.",
    mcpDetectionTiming: "TASK comprueba automáticamente al abrir esta página; usa Comprobar de nuevo para actualizar.",
    mcpNpmBoundary: "TASK solo comprueba y explica el estado de MCP; la instalación y actualización siguen usando npm.",
  ...
  driverStore: {
    ...
    javaRuntimeManaged: "JRE administrado por TASK",
