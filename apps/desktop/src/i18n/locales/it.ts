export default {
  ...
  updates: {
    ...
    portableManualUpdate: "Le build portatili non possono utilizzare l'installer in-app. Scarica lo ZIP portatile dalla pagina delle release, quindi estrailo nella cartella TASK corrente per mantenere portable.dbx e i dati.",
