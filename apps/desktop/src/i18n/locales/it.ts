export default {
  ...
  updates: {
    ...
    availableMessage: "TASK {latest} è disponibile. Stai usando la versione {current}.",
    upToDate: "TASK è aggiornato ({version}).",
    ...
    portableManualUpdate: "Le build portatili non possono utilizzare l'installer in-app. Scarica lo ZIP portatile dalla pagina delle release, quindi estrailo nella cartella TASK corrente per mantenere portable.task e i dati.",
  ...
  connection: {
    ...
    jdbcPluginHint: "Installa prima il plugin TASK JDBC, quindi importa il file JAR del driver JDBC del fornitore del database.",
  ...
  grid: {
    ...
    queryEditUnsupported: {
      ...
      "metadata-unavailable": "TASK non è riuscito a caricare i metadati della tabella, quindi la modifica del risultato è disabilitata.",
    },
  ...
  configExport: {
    ...
    cryptoUnavailable: "L'importazione cifrata non è disponibile in questo contesto del browser. Usa HTTPS, localhost o TASK Desktop.",
  ...
  contextMenu: {
    ...
    parameterDefaultHint: "Quando DEFAULT è selezionato, TASK omette quell'argomento in modo che il database utilizzi il valore predefinito della procedura.",
  ...
  settings: {
    ...
    iconThemeDefaultDescription: "Utilizza l'icona colorata dell'app TASK.",
    iconThemeBlack: "Nero",
    iconThemeBlackDescription: "Utilizza il marchio TASK nero per la finestra, la barra delle applicazioni e il logo.",
    showTrayIcon: "Mostra icona nella barra delle applicazioni/menu",
    showTrayIconDescription: "Se disattivato, non viene mostrata alcuna icona, ma la chiusura della finestra nasconderà comunque TASK in background.",
    updateNotificationsEnabled: "Abilita promemoria aggiornamenti",
    updateNotificationsEnabledDescription: "Se disattivato, TASK non controllerà automaticamente gli aggiornamenti dell'app o dei driver e non mostrerà badge. I controlli manuali restano disponibili.",
    ...
    syncWebDavDescription: "Carica o ripristina uno snapshot di TASK da un servizio di archiviazione compatibile con WebDAV.",
    ...
    syncRemotePathDescription: "TASK creerà le cartelle superiori mancanti durante il caricamento.",
    syncSecretNotice: "Per impostazione predefinita, TASK sincronizza solo i dettagli e le impostazioni di connessione. Le password dei database, le password SSH, le password proxy, le stringhe di connessione e le chiavi API AI rimangono locali.",
    syncSecrets: "Sincronizza i segreti crittografati",
    syncSecretsDescription: "Se abilitato, TASK crittografa le password del database, le password SSH e le chiavi API AI prima di caricarle su WebDAV.",
    syncSecretsPassphrase: "Password di sincronizzazione",
    syncSecretsPassphraseDescription: "Questa password viene utilizzata solo per crittografare e ripristinare i dati sensibili. TASK non la salva; inseriscila nuovamente su ciascun dispositivo.",
    syncTest: "Verifica",
    syncUpload: "Carica",
    ...
    syncDownloadConfirm: "Scaricare e applicare lo snapshot TASK remoto? I metadati locali e i file SQL salvati verranno sostituiti.",
    apply: "Applica",
    ...
    mcpTitle: "Server MCP",
    mcpDescription: "Verifica l'installazione e la versione del Server TASK MCP utilizzata da Claude Code, Cursor e altri agenti.",
    ...
    mcpReadonlyModeDescription: "Aggiunge TASK_MCP_ALLOW_WRITES=0 alla configurazione di esempio in modo che la sessione MCP rimanga di sola query.",
    mcpAllowDangerous: "Consenti SQL pericoloso",
    mcpAllowDangerousDescription: "Aggiunge TASK_MCP_ALLOW_DANGEROUS_SQL=1 alla configurazione di esempio in modo che siano consentite istruzioni come DROP, TRUNCATE, ALTER e simili.",
    mcpDetectionTiming: "TASK esegue la verifica automaticamente all'apertura di questa pagina; usa di nuovo Verifica per aggiornare.",
    mcpNpmBoundary: "TASK verifica e spiega solo lo stato di MCP; l'installazione e gli aggiornamenti vengono comunque eseguiti tramite npm.",
  ...
  driverStore: {
    ...
    javaRuntimeManaged: "JRE gestito da TASK",
