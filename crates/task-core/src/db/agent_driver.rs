...
impl AgentDriverClient {
    ...
    /// they speak the TASK stdin/stdout JSON-RPC protocol.
...
mod tests {
    ...
    fn agent_java_args_include_oracle_network_compatibility_flags() {
        let args = agent_java_args("/tmp/task-agent-oracle.jar");
    ...
    fn agent_java_args_open_java_sql_for_legacy_timestamp_serializers() {
        let args = agent_java_args("/tmp/task-agent-dameng.jar");
    ...
    fn agent_java_args_skip_module_flags_for_oracle_10g_profile() {
        let args = agent_java_args("/tmp/task/drivers/oracle-10g/agent.jar");
    ...
    fn agent_java_args_disable_ambient_proxy_settings() {
        let args = agent_java_args("/tmp/task-agent-opengauss.jar");
    ...
    fn agent_java_args_prefer_ipv4_for_kingbase() {
        let args = agent_java_args("/tmp/task/drivers/kingbase/agent.jar");
    ...
    fn agent_java_args_do_not_prefer_ipv4_for_other_agents() {
        let args = agent_java_args("/tmp/task/drivers/highgo/agent.jar");
    ...
    fn formats_agent_process_error_with_exit_status_and_stderr_tail() {
        ...
        stderr_tail.push_line("\tat com.task.agent.hive.HiveAgent.connect(HiveAgent.kt:21)".to_string());
