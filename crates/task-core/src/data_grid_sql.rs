...
const TASK_ROWID_COLUMN: &str = "__TASK_ROWID";
pub(crate) const TASK_NEO4J_ELEMENT_ID_COLUMN: &str = "__TASK_ELEMENT_ID";
pub(crate) const TASK_TDENGINE_TBNAME_COLUMN: &str = "tbname";
...
fn is_oracle_row_id(database_type: Option<DatabaseType>, name: Option<&str>) -> bool {
    database_type == Some(DatabaseType::Oracle) && name.is_some_and(|name| name.eq_ignore_ascii_case(TASK_ROWID_COLUMN))
}

pub(crate) fn is_neo4j_element_id(database_type: Option<DatabaseType>, name: Option<&str>) -> bool {
    database_type == Some(DatabaseType::Neo4j) && name == Some(TASK_NEO4J_ELEMENT_ID_COLUMN)
}
