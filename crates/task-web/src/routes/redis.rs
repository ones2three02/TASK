...
pub async fn scan_keys(
    ...
    let result = task_core::redis_ops::redis_scan_keys_core(
        &state.app,
        &req.connection_id,
        req.db,
        req.cursor,
...
pub async fn scan_values(
    ...
    let result = task_core::redis_ops::redis_scan_values_core(
        &state.app,
        &req.connection_id,
        req.db,
        req.cursor,
...
pub async fn set_string(
    ...
    task_core::redis_ops::redis_set_string_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn hash_set(
    ...
    task_core::redis_ops::redis_hash_set_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn list_push(
    ...
    let value = req.value.as_deref().unwrap_or("");
    task_core::redis_ops::redis_list_push_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn set_add(
    ...
    task_core::redis_ops::redis_set_add_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn set_remove(
    ...
    task_core::redis_ops::redis_set_remove_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn zadd(State(state): State<Arc<WebState>>, Json(req): Json<RedisZaddRequest>) -> Result<Json<()>, AppError> {
    task_core::redis_ops::redis_zadd_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn stream_add(
    ...
    task_core::redis_ops::redis_stream_add_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn json_set(
    ...
    task_core::redis_ops::redis_json_set_in_db_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.key_raw,
...
pub async fn execute_command(
    ...
    let result = task_core::redis_ops::redis_execute_command_core(
        &state.app,
        &req.connection_id,
        req.db,
        &req.command,
