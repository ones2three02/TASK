...
pub struct FindStatementAtCursorRequest {
    ...
    pub database_type: Option<task_core::models::connection::DatabaseType>,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct PrepareQueryPaginationExecutionPlanRequest {
    pub options: task_core::query_result_sql::QueryPaginationExecutionPlanOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildSortedQuerySqlRequest {
    pub options: task_core::query_result_sql::SortedQuerySqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildExplainSqlRequest {
    pub options: task_core::query_execution_sql::ExplainSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDroppedFilePreviewSqlRequest {
    pub options: task_core::query_execution_sql::DroppedFilePreviewSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildTableSelectSqlRequest {
    pub options: task_core::sql_dialect::TableDataSelectSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDatabaseSearchSqlRequest {
    pub options: task_core::database_search_sql::DatabaseSearchSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildSearchResultWhereRequest {
    pub options: task_core::database_search_sql::SearchResultWhereOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildRenameObjectSqlRequest {
    pub options: task_core::db_admin_sql::RenameObjectSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildCreateDatabaseSqlRequest {
    pub options: task_core::db_admin_sql::CreateDatabaseSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDuckDbAttachDatabaseSqlRequest {
    pub options: task_core::db_admin_sql::DuckDbAttachDatabaseSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDropObjectSqlRequest {
    pub options: task_core::db_admin_sql::DropObjectSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildTableAdminSqlRequest {
    pub options: task_core::db_admin_sql::TableAdminSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDropTableChildObjectSqlRequest {
    pub options: task_core::db_admin_sql::DropTableChildObjectSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDatabaseNameSqlRequest {
    pub options: task_core::db_admin_sql::DatabaseNameSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildSchemaNameSqlRequest {
    pub options: task_core::db_admin_sql::SchemaNameSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDuplicateTableStructureSqlRequest {
    pub options: task_core::db_admin_sql::DuplicateTableStructureSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildExecutableObjectSourceRequest {
    pub input: task_core::object_source_sql::EditableObjectSourceSqlInput,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildRoutineRenameObjectSourceRequest {
    pub input: task_core::object_source_sql::RoutineRenameObjectSourceInput,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildViewDdlRequest {
    pub input: task_core::object_source_sql::BuildViewDdlInput,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildTableStructureSqlRequest {
    pub options: task_core::table_structure_sql::TableStructureSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildSingleColumnAlterSqlRequest {
    pub options: task_core::table_structure_sql::SingleColumnAlterSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct PrepareDataGridSaveRequest {
    pub options: task_core::data_grid_sql::DataGridSaveStatementOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDataGridCopyUpdateStatementsRequest {
    pub options: task_core::data_grid_sql::DataGridCopyUpdateStatementOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDataGridCopyInsertStatementRequest {
    pub options: task_core::data_grid_sql::DataGridCopyInsertStatementOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDataGridContextFilterConditionRequest {
    pub options: task_core::data_grid_sql::DataGridContextFilterConditionOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDataGridColumnValueFilterConditionRequest {
    pub options: task_core::data_grid_sql::DataGridColumnValueFilterConditionOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDataGridCountSqlRequest {
    pub options: task_core::data_grid_sql::DataGridCountSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildHiveTablePropertiesSqlRequest {
    pub options: task_core::data_grid_sql::HiveTablePropertiesSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildExportInsertStatementsRequest {
    pub options: task_core::database_export::BuildExportInsertStatementsOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildExportSqlInsertRequest {
    pub options: task_core::database_export::BuildExportSqlInsertOptions,
}
...
pub async fn execute_query(
    ...
    let result = task_core::query::execute_sql_statement_with_options(
        &state.app,
        &req.connection_id,
        &req.database,
        &req.sql,
...
pub async fn execute_batch(
    ...
    let result = task_core::query::execute_statements(
        &state.app,
        &req.connection_id,
        &req.database,
        &req.statements,
...
pub async fn close_query_session(
    ...
    let closed = task_core::query::close_query_session(
        &state.app,
        &req.connection_id,
        &req.database,
        &req.session_id,
...
pub async fn execute_script(
    ...
    let statements = db_type
        .map(|db_type| task_core::sql::split_sql_statements_for_database(&req.sql, db_type))
        .unwrap_or_else(|| task_core::sql::split_sql_statements(&req.sql));
    let result = task_core::query::execute_statements(
        &state.app,
        &req.connection_id,
        &req.database,
...
pub async fn execute_in_transaction(
    ...
    let result = task_core::query::execute_statements_in_transaction(
        &state.app,
        &req.connection_id,
        &req.database,
        &req.statements,
...
pub async fn find_statement_at_cursor(Json(req): Json<FindStatementAtCursorRequest>) -> Json<String> {
    Json(
        req.database_type
            .map(|db_type| task_core::sql::find_statement_at_cursor_for_database(&req.sql, req.cursor_pos, db_type))
            .unwrap_or_else(|| task_core::sql::find_statement_at_cursor(&req.sql, req.cursor_pos)),
    )
}

pub async fn prepare_query_pagination_execution_plan(
    Json(req): Json<PrepareQueryPaginationExecutionPlanRequest>,
) -> Json<task_core::query_result_sql::QueryPaginationExecutionPlan> {
    Json(task_core::query_result_sql::build_query_pagination_execution_plan(req.options))
}

pub async fn build_sorted_query_sql(
    Json(req): Json<BuildSortedQuerySqlRequest>,
) -> Json<task_core::query_result_sql::QuerySqlBuildResult> {
    Json(task_core::query_result_sql::build_sorted_query_sql(req.options))
}

pub async fn build_explain_sql(
    Json(req): Json<BuildExplainSqlRequest>,
) -> Json<task_core::query_execution_sql::ExplainSqlBuildResult> {
    Json(task_core::query_execution_sql::build_explain_sql(req.options))
}
...
pub async fn build_create_user_sql(Json(req): Json<BuildCreateUserSqlRequest>) -> Result<Json<String>, AppError> {
    Ok(Json(task_core::db_admin_sql::build_create_user_sql(&req.username, &req.password, &req.tablespace)))
}

pub async fn build_dropped_file_preview_sql(
    Json(req): Json<BuildDroppedFilePreviewSqlRequest>,
) -> Json<Option<String>> {
    Json(task_core::query_execution_sql::build_dropped_file_preview_sql(req.options))
}

pub async fn build_table_select_sql(Json(req): Json<BuildTableSelectSqlRequest>) -> Json<String> {
    Json(task_core::sql_dialect::build_table_data_select_sql(req.options))
}

pub async fn build_database_search_sql(
    Json(req): Json<BuildDatabaseSearchSqlRequest>,
) -> Json<Option<task_core::database_search_sql::DatabaseSearchSql>> {
    Json(task_core::database_search_sql::build_database_search_sql(req.options))
}

pub async fn build_search_result_where(Json(req): Json<BuildSearchResultWhereRequest>) -> Json<String> {
    Json(task_core::database_search_sql::build_search_result_where(req.options))
}
...
pub async fn build_view_ddl_sql(Json(req): Json<BuildViewDdlRequest>) -> Json<String> {
    Json(task_core::object_source_sql::build_view_ddl_sql(req.input))
}

pub async fn build_table_structure_change_sql(
    Json(req): Json<BuildTableStructureSqlRequest>,
) -> Json<task_core::table_structure_sql::TableStructureSqlResult> {
    Json(task_core::table_structure_sql::build_table_structure_change_sql(req.options))
}

pub async fn build_create_table_sql(
    Json(req): Json<BuildTableStructureSqlRequest>,
) -> Json<task_core::table_structure_sql::TableStructureSqlResult> {
    Json(task_core::table_structure_sql::build_create_table_sql(req.options))
}

pub async fn build_single_column_alter_sql(
    Json(req): Json<BuildSingleColumnAlterSqlRequest>,
) -> Json<task_core::table_structure_sql::TableStructureSqlResult> {
    Json(task_core::table_structure_sql::build_single_column_alter_sql(req.options))
}

pub async fn analyze_editable_query_editability(
    Json(req): Json<AnalyzeEditableQueryRequest>,
) -> Json<task_core::sql_editability::QueryEditability> {
    Json(task_core::sql_editability::analyze_editable_query_editability(&req.sql))
}

pub async fn prepare_data_grid_save(
    Json(req): Json<PrepareDataGridSaveRequest>,
) -> Json<task_core::data_grid_sql::DataGridSavePreparation> {
    Json(task_core::data_grid_sql::prepare_data_grid_save(req.options))
}

pub async fn build_data_grid_copy_update_statements(
    Json(req): Json<BuildDataGridCopyUpdateStatementsRequest>,
) -> Json<Vec<String>> {
    Json(task_core::data_grid_sql::build_data_grid_copy_update_statements(req.options))
}

pub async fn build_data_grid_copy_insert_statement(
    Json(req): Json<BuildDataGridCopyInsertStatementRequest>,
) -> Json<Option<String>> {
    Json(task_core::data_grid_sql::build_data_grid_copy_insert_statement(req.options))
}

pub async fn build_data_grid_context_filter_condition(
    Json(req): Json<BuildDataGridContextFilterConditionRequest>,
) -> Json<Option<String>> {
    Json(task_core::data_grid_sql::build_data_grid_context_filter_condition(req.options))
}

pub async fn build_data_grid_column_value_filter_condition(
    Json(req): Json<BuildDataGridColumnValueFilterConditionRequest>,
) -> Json<Option<String>> {
    Json(task_core::data_grid_sql::build_data_grid_column_value_filter_condition(req.options))
}

pub async fn build_data_grid_count_sql(Json(req): Json<BuildDataGridCountSqlRequest>) -> Json<String> {
    Json(task_core::data_grid_sql::build_data_grid_count_sql(req.options))
}

pub async fn build_hive_table_properties_sql(Json(req): Json<BuildHiveTablePropertiesSqlRequest>) -> Json<String> {
    Json(task_core::data_grid_sql::build_hive_table_properties_sql(req.options))
}
